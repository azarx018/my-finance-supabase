...
// Ported from nav.js's fab display branches: hidden on settings/lainnya/
// budget/kalender/dashboard/tabungan, shown plain on riwayat/analitik,
// and shown with a variant color on dompet ('wallet') / hutang ('expense').
export const FAB_VISIBLE_PAGES = ['riwayat', 'analitik', 'dompet', 'hutang'];
