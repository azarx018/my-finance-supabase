...
<div class="p-4 flex flex-col gap-6 max-w-md mx-auto">
  ...
  <section>
    ...
    <div class="bg-base-card rounded-lg border border-border p-4 flex flex-col gap-3">
  ...
  <section>
    ...
    <div class="bg-base-card rounded-lg border border-border p-4 flex flex-col gap-2">
